...
ALTER TABLE GROUP_MEMBERS ADD CONSTRAINT FK_GROUPID FOREIGN KEY (GROUP_ID) REFERENCES GROUPS (GROUP_ID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE GROUP_MEMBERS ADD CONSTRAINT FK_USERID FOREIGN KEY(USER_ID) REFERECES USERS (USER_ID) ON DELETE CASCADE ON UPDATE CASCADE;